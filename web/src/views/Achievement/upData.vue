      ...
      <el-card class="right top" shadow="hover" v-loading="loading1">
        ...
        <el-form>
          <el-form-item style="margin-bottom: 40px;" prop="title">
            <MdInput v-model="page1.name" name="name" required>竞赛名称</MdInput>
          </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    ...
    getDataPage1() {
      this.loading1 = true;
      postFrom("/tea/competition/findAll", this.page1).then((response) => {
        this.competitionDate = response.data.content;
        this.page1.totalElements = response.data.totalElements;
        this.loading1 = false;
      });
    ...
    initWebSocket() {
      this.websocket = new WebSocket(
        "ws://" + location.host + "/socket/" + this.userId
      );
